...
class Solution {
    ...
    private void dfs(int[][] image, int sr, int sc, int cur, int newColor, Set<String> visited) {
        ...
        visited.add(sr + "#" + sc);
        dfs(image, sr + 1, sc, cur, newColor, visited);
        dfs(image, sr - 1, sc, cur, newColor, visited);
        dfs(image, sr, sc + 1, cur, newColor, visited);
        dfs(image, sr, sc - 1, cur, newColor, visited);
    }
}
